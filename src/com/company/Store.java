    ...
    public static void buyAnimal(Player player,int action){
        ...
        switch (action) {
            case 1 -> { player.playerAnimals.add(new Bear(newAnimalName,gender));
                player.gold -= 10;}
            case 2 -> { player.playerAnimals.add(new Wolf(newAnimalName,gender));
                player.gold -= 20;}
            ...
            case 4 -> { player.playerAnimals.add(new Raven(newAnimalName,gender));
                player.gold -= 40;}
            case 5 -> { player.playerAnimals.add(new Tiger(newAnimalName,gender));
                player.gold -= 50;}
        }
